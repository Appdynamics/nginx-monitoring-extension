...
public class JSONResponseParserTest {
    ...
    public void extractProcessStats() throws IOException {
        ...
        if(stat != null) {
            parser = new JSONResponseParser(stat, contextConfiguration, metricWriter, metricPrefix, "url" );
            parser.run();
    ...
    public void extractHttpRequestsStats() throws IOException{
        ...
        when(EntityUtils.toString(entity, "UTF-8")).thenReturn(responseBody);
        if(stat != null) {
            parser = new JSONResponseParser(stat, contextConfiguration, metricWriter, metricPrefix + "|http" , "url" );
            parser.run();
