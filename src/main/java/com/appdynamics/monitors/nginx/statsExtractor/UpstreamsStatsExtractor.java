...
public class UpstreamsStatsExtractor implements StatsExtractor {
    ...
    public Map<String, String> extractStats(JSONObject respJson) {
        ...
        Map<String, String> upstreamsStats = getUpstreamsStats(upstreams);
        return upstreamsStats;
    }

    private Map<String, String> getUpstreamsStats(JSONObject upstreams) {
        ...
        for (String serverGroupName : serverGroupNames) {
            ...
            for (int i = 0; i < serverGroups.length(); i++) {
                ...
                long keepalive = server.getLong("keepalive");
                upstreamsStats.put("upstreams|" + serverGroupName + " |" + serverIp + "|keepalive", String.valueOf(keepalive));
